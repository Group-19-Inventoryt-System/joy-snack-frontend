    ...
    <aside className="h-full flex flex-col relative border-white/60 bg-orange-900 px-4 py-8 backdrop-blur w-64 border-r overflow-y-auto">
      ...
      <div className="w-full flex flex-col items-center justify-center mb-8">
        <img
          src="/logo.png"
          alt=""
          className="w-17 h-17 object-contain mb-3 drop-shadow-xl"
        />
        ...
        {sidebarItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 rounded-full px-5 py-4 text-sm font-sulphur font-bold uppercase tracking-widest transition-all duration-300 ${
                isActive
                  ? "bg-white text-orange-900 shadow-lg shadow-black/10 scale-[1.0]"
